...
<head>
<meta charset="UTF-8">
<title>RAM Management</title>

<link rel="stylesheet" href="${pageContext.request.contextPath}/css/ram.css">
...
<form action="RAMController" method="get">

<input type="hidden" name="action" value="search">

<input type="text" name="keyword" placeholder="Search RAM">
